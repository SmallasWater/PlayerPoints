...
import net.player.commands.player.LeadSubCommand;
import net.player.commands.player.LookSubCommand;
import net.player.commands.player.MeSubCommand;
import net.player.commands.player.PaySubCommand;
 ...
 * @author 若水
 */
public class PointCommand extends PluginCommand<PlayerPoints> {

    private final List<SubCommand> commands = new ArrayList<>();
    private final ConcurrentHashMap<String, Integer> SubCommand = new ConcurrentHashMap<>();

    public PointCommand(PlayerPoints owner) {
        super("points", owner);
